...
class Autentifikasi extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                class="alert alert-danger alert-message" role="alert">Password salah!!</div>');
    ...
    //bahasa sendiri yaitu jika password dan repeat password tidak diinput sama, maka pesannya//'Password Tidak Sama'. jika password diisi kurang dari 3 digit, maka pesannya adalah 
